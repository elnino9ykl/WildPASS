...
def parse_args():
	...
	parser.add_argument('--alpha' , type=int, default =1 ) ## Cross dataset loss term coeff.
	parser.add_argument('--beta' , type=int , default =1 ) ## Within dataset loss term coeff. 
	...
	parser.add_argument('--epochs-save', type=int, default=5)    #You can use this value to save model every X epochs
